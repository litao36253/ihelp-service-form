      ...
      <el-col :span="18" :offset="3">
        <div style="padding-top: 34px;">
                ...
                <el-row :gutter="16" :class="['padTop']">
                  ...
                  <el-col :span="9">
                    <!--<el-form-item prop="CHANNEL">-->
                      <Select v-model="CHANNEL" :class="['fullWidth']" clearable>
                        <Option v-for="item in $store.state.chanelList" :value="item.id" :key="item.id">{{ item.name }}</Option>
                      </Select>
                    <!--</el-form-item>-->
                  </el-col>
                  ...
                  <el-col :span="9">
                    <Select v-model="CONTRY" :class="['fullWidth']" disabled>
                      <Option v-for="item in $store.state.countryList" :value="item.id" :key="item.id">{{ item.name }}</Option>
                    </Select>
                  </el-col>
                </el-row>
                <el-row :gutter="16" :class="['padTop']">
                ...
                <el-row :gutter="16" :class="['padTop']">
                  ...
                  <el-col :span="5">
                    <Select v-model="BUILDING" :class="['fullWidth']" :clearable="!disablebuild" :disabled="disablebuild">
                      <Option v-for="item in $store.state.buildList" :value="item.BUILDNAME" :key="item.BUILD_SPEC_ID">{{ item.BUILDNAME }}</Option>
                    </Select>
                  </el-col>
                  ...
                  <el-col :span="3">
                    <Select v-model="FLOORS" :class="['fullWidth']" :clearable="!disablefloor" :disabled="disablefloor">
                      <Option v-for="item in $store.state.floorList" :value="item.FLOORNAME" :key="item.FLOOR_SPEC_ID">{{ item.FLOORNAME }}</Option>
                    </Select>
                  </el-col>
                ...
                <el-row :gutter="16">
                  ...
                  <el-col :span="9">
                    <Select v-model="QUEST_TYPE" :class="['fullWidth']" clearable>
                      <Option v-for="item in $store.state.questTypeList" :value="item['spi:triNameTX']" :key="item['spi:trildTX']">{{ item['spi:triNameTX'] }}</Option>
                    </Select>
                  </el-col>
                </el-row>
                <el-row :gutter="16" :class="['padTop']">
                  ...
                  <el-col :span="9">
                    <Select v-model="URGENT" :class="['fullWidth']" clearable>
                      <Option v-for="item in $store.state.urgentList" :value="item['spi:triNameTX']" :key="item['spi:triNameTX']">{{ item['spi:triNameTX'] }}</Option>
                    </Select>
                  </el-col>
          ...
          <el-row :class="['padTop','padBot']">
            <el-col :span="3" :offset="9" :class="['alignCenter']">
...
export default {
  ...
  methods:{
    commitAll(service,STATE,title) {
      ...
      this.$nextTick(async () => {
        try {
          await api.commitAll(this.$store.state,service,STATE,title);
